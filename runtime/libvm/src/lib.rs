...
pub use crate::machine::{
    ...
    MachineDirectoryPage, MachineEnabledAgent, MachineEntryKind, MachineExit, MachineExitCommand,
    MachineExitOutcome, MachineFileDownload, MachineFileEntry, MachineFileUploadOptions,
    MachineFilesystemMetrics, MachineFreshness, MachineGuestBootMode, MachineGuestBootReport,
    MachineGuestConfig, MachineKillOptions, MachineLoadAverageMetrics, MachineMemoryMetrics,
