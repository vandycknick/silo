...
| State       | Meaning                                           |
| ----------- | ------------------------------------------------- |
| Draft       | Directional work in progress, not ready for adoption. |
...
| 0005 | silo-vmmon endpoint plugins for vsock streams                 | Superseded  | 2026-04-12 | `docs/adr/0005-vmmon-vsock-endpoint-plugins.md`  |
...
| 0008 | silo-vmmon host and guest agent gRPC APIs                     | Implemented | 2026-07-08 | `docs/adr/0008-vmmon-host-and-guest-grpc-api.md` |
...
| 0018 | silo-vmmon contract                                           | Accepted    | 2026-09-24 | `docs/adr/0018-silo-vmmon-contract.md`           |
